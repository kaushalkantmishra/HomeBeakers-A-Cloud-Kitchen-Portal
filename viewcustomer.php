...
<div class="col-12">
			<h5 class="text-light-black fw-700">View Customer</h5>
...
<table id="datatable" class="table table-striped table-bordered">
	...
	<tbody>
	<?php
	$sql ="SELECT customer.*,location.locationname,city.city from customer  LEFT JOIN location ON customer.locationid=location.locationid LEFT JOIN city ON customer.cityid=city.cityid ";
	$qsql= mysqli_query($con,$sql);
	while($rs = mysqli_fetch_array($qsql))
	{
		echo "<tr>
			...
			| 
			<a href='viewcustomer.php?delid=$rs[0]' class='btn btn-warning' onclick='return confirmdelete()' >Delete</a>
			</td>
		</tr>";
	}
	?>
